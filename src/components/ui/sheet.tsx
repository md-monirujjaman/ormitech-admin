...
const sheetVariants = cva(
  'fixed z-50 gap-4 bg-sidebar text-sidebar-foreground shadow-lg transition ease-in-out data-[state=closed]:duration-200 data-[state=open]:duration-300',
  {
    variants: {
      side: {
        ...
        right: 'inset-y-0 right-0 h-full w-80 border-l border-border bg-popover text-popover-foreground data-[state=closed]:slide-out-to-right data-[state=open]:slide-in-from-right',
      },
    },
